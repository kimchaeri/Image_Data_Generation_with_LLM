...
def get_dataset(args):
    ...
    if args.dataset=='cifar10':
        ...
        test_dataset = torchvision.datasets.CIFAR10(root=cifar10_dataset_path, train=False, download=True, transform = test_normalize)
        ...
        test_dataset = torchvision.datasets.CIFAR100(root=cifar100_dataset_path, train=False, download=True, transform = test_normalize)
    ...
    if args.data_type == "augmented_data":
        ...
        if test_dataset is None:
            test_dataset = torchvision.datasets.ImageFolder(root = test_data_path, transform = test_normalize)
