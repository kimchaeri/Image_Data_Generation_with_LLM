...
def get_args():
    ...
    argparser.add_argument('--data_type', type=str, help='data type', choices=['generated_data', 'origin', 'augmented_data', 'generated_data_gpt3'], default='origin')
    argparser.add_argument('--aug_strategy', type=str, help='augmentation strategy', choices=['mixup', 'cutmix', 'crop', 'rotate', 'horizontal_flip', 'crop_rotate_horizontal_flip', 'crop_rotate_horizontal_flip_mixup', "Nothing"], default="Nothing")
    ...
    argparser.add_argument('--checkpoint_folder', type=str, help='checkpoint save folder', default="/home/s20225103/Data_Generation/checkpoints")
