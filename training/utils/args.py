...
def get_args():
    ...
    argparser.add_argument('--model_type', type=str, help='model to use', choices=['Resnet', 'ViT', 'CLIP_ViT', "wide_resnet_28x10"], default='Resnet')
    ...
    argparser.add_argument('--aug_strategy', action='store_true', help='Set the flag to True')
    
    argparser.add_argument('--lr', type=float, help='learning rate', default=0.01)
    argparser.add_argument('--weight_decay', type=float, help='weight decay', default=5e-4)
